...
/**
 * Encapsulates the core parameters and data captured during the authentication flow, inL
...
public class FlowParameters implements Parcelable {
    ...
    public FlowParameters(
            ...
            @NonNull List<AuthUI.IdpConfig> providerInfo,
        ...
        this.providerInfo = null; //Collections.unmodifiableList(Preconditions.checkNotNull(providerInfo, "providerInfo cannot be null"));
    ...
    public static final Creator<FlowParameters> CREATOR = new Creator<FlowParameters>() {
        ...
        public FlowParameters createFromParcel(Parcel in) {
            ...
            List<AuthUI.IdpConfig> providerInfo = in.createTypedArrayList(AuthUI.IdpConfig.CREATOR);
